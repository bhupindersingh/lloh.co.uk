...
class Articles extends CI_Model
{
    public function __construct() {
 	...
 	public function record_count_articles() {
        return $this->db->count_all_results("posts", array('post_type' =>'article'));
    }   
	...
	//Add News
	public function add_articles($image){
		$data = array(		   
	...
	//Delete news
	public function delete_articles($POSTID){
		$this->db->delete('posts', array('ID' => $POSTID)); 
		
		return true;  
	}
	public function get_articles($POSTID){
	...
	public function update_articles($image){
		$data = array(		   
		   'title' => $this->security->xss_clean($this->input->post('title')),
		   'value' => $this->security->xss_clean($this->input->post('txtDescription')),	
