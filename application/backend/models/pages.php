...
class Pages extends CI_Model
{
    public function __construct() {
 	...
 	public function record_count_pages() {
        return $this->db->count_all_results("posts", array('post_type' =>'page'));
    }   
	...
	//Delete news
	public function delete_pages($POSTID){
		$this->db->delete('posts', array('ID' => $POSTID)); 
		
		return true;  
	}
	public function get_pages($POSTID){
