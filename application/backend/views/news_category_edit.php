				...
				<div class="columns ">
                                	...
                                	<div class="entry-edit">
                                        ...
                                        <fieldset id="group_fields4">
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    <tr class="hidden">
                                                        <td class="label"><label for="name">CATEGORY ID </label></td>
                                                        <td class="value">
                                                        	<?php echo $results[0]->CATEGORYID;?>
                                                        </td>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                        	<input id="category_name" name="category_name" value="<?php echo $results[0]->category_name;?>" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
                            ...
                            <form action="<?php echo site_url('/admin/news_category/update_category/');?>?CATEGORYID=<?php echo $this->input->get('CATEGORYID');?>" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
