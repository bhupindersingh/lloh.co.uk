                                ...
                                <div id="isoft_group_1_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Manage Articles</h4>
        			...
        			<div id="customerGrid">
        				...
        				<tr>
            				...
            				<td class="filter-actions a-right">
                            	<button  id="id_ffba3971e132ae3d78c160244ea09b39" type="button" class="scalable " onclick="document.location.href='<?php echo site_url('/admin/manage_articles/');?>'" style=""><span>Reset Filter</span></button>
                        ...
                        <div class="grid">
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" "><?php echo $data->title;?></td>   
                                         <td class=" "><a href="<?php echo base_url().'article/'.$data->post_name.'.html';?>" target="_blank"><?php echo base_url().'article/'.$data->post_name.'.html';?></a></td>    
                                        <td><?php echo date("F j, Y",strtotime($data->post_date));?></td>
                                        <td><?php echo ucwords($data->post_status);?></td>          
                                        <td class=" last"><a href="<?php echo site_url('/admin/manage_articles/edit/');?>?POSTID=<?php echo $data->ID;?>">Edit</a>&nbsp;|&nbsp;<form name="c<?php echo $data->ID;?>" id="c<?php echo $data->ID;?>" action="" method="post">
                            ...
                            <li><a href="<?php echo site_url('/admin/manage_articles/add_articles/');?>" id="isoft_group_1" name="group_1" title="Add Pages" class="tab-item-link ">
                                    <span>
                                        <span class="changed" title=""></span>
                                        <span class="error" title=""></span>
                                        Add Article
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
							<div id="messages">
                                ...
                                <ul class="messages">
                                    <li class="error-msg">
                                    	<ul><li>Sorry, no article found.</li></ul>
                                    </li>
                                </ul>
								<?php endif;?>
								<?php if($message !=''):?>
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Manage Articles</h3>
                               <p class="content-buttons form-buttons">
                                    <button  id="id_be616be1324d8ae4516f276d17d34b9c" type="button" class="scalable add" onclick="document.location.href='<?php echo site_url('/admin/manage_articles/add_articles/');?>'" style=""><span>Add Article</span></button>			
                               </p>
                            </div>
                            
                            <form action="<?php echo site_url('/admin/manage_articles/');?>" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
