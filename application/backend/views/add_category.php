                                            ...
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                        	<input id="organization" name="organization" value="<?php echo set_value("organization");?>" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Organization Groups - Create Category</h3>
                               <p class="content-buttons form-buttons">
                                    <button  id="id_be616be1324d8ae4516f276d17d34b9c" type="button" class="scalable save" onclick="document.main_form.submit();" style=""><span>Save Changes</span></button>			
                                </p>
                            </div>
                            
                            <form action="<?php echo site_url('/admin/organization_groups/submit/');?>" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
