				...
				<div class="columns ">
					<div class="side-col" id="page:left">
                        ...
                        <ul id="isoft" class="tabs">
                            ...
                            <li><a href="<?php echo site_url('/admin/manage_pages/add_pages/');?>" id="isoft_group_2" name="group_2" title="Add Page" class="tab-item-link ">
                                    <span>
                                        <span class="changed" title=""></span>
                                        <span class="error" title=""></span>
                                        Add Page
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Pages - Edit Page</h3>
                               <p class="content-buttons form-buttons">
                                    <button  id="id_be616be1324d8ae4516f276d17d34b9c" type="button" class="scalable save" onclick="document.main_form.submit();" style=""><span>Save Changes</span></button>			
                                </p>
                            </div>
                            
                            <form action="<?php echo site_url('/admin/manage_pages/update_pages/');?>?POSTID=<?php echo $this->input->get('POSTID');?>" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
