                                ...
                                <div id="isoft_group_1_content" style="display:none;">
                                	<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Edit Media Image</h4>
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Media - Edit Media Image</h3>
                               <p class="content-buttons form-buttons">
                                    <button  id="id_be616be1324d8ae4516f276d17d34b9c" type="button" class="scalable save" onclick="document.main_form.submit();" style=""><span>Save Changes</span></button>			
                                </p>
                            </div>
                            
                            <form action="<?php echo site_url('/admin/manage_images/update_image/');?>?MEDIAID=<?php echo $this->input->get('MEDIAID');?>" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
