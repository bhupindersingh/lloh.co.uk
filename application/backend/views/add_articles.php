                                            ...
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="scope-label">[META DESCRIPTION OF THE ARTICLE]</td>
                                                            <td><small></small></td>
                                                    </tr>                                                     
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="scope-label">[STATUS OF THE ARTICLE]</td>
                                                            <td><small></small></td>
                                                    </tr>                                                 
                                                </tbody>
                                                </table>
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Poverty Buster - Add Article</h3>
                               <p class="content-buttons form-buttons">
                                    <button  id="id_be616be1324d8ae4516f276d17d34b9c" type="button" class="scalable save" onclick="document.main_form.submit();" style=""><span>Save Changes</span></button>			
                                </p>
                            </div>
                            
                            <form action="<?php echo site_url('/admin/manage_articles/submit/');?>" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
