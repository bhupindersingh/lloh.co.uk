                                            ...
                                            <?php echo "<div id='error'>".validation_errors()."</div>" ?>
                                                ...
                                                <tbody>
                                                	<tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                        	<input id="username" name="username" value="<?php echo set_value('username'); ?>" class=" required-entry required-entry input-text" type="text"/>
                                                        </td>
                                                	...
                                                	<tr class="hidden">
                                                        ...
                                                        <td class="value">
                                                        	<input id="password" name="password" value="<?php echo set_value('password'); ?>" class=" required-entry required-entry input-text" type="password"/>
                                                        </td>
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
                            <div class="content-header">
                               <h3 class="icon-head head-products">Administrators - Create Administrator</h3>
                            ...
                            <form action="<?php echo site_url('/admin/admins_manage/submit_admin/');?>" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
