    ...
    <div class="lsize">
            ...
            <div class="l_part">
				...
				?>
                    ...
                    <div class="img"><a href="<?php echo site_url('/news/'.page_hperlink($row->ID));?>"><img src="<?php echo base_url()?>/uploads/images/thumb_<?php echo $row->image?>" alt="" class="bor_01" height="140" width="140"/></a></div>
                    <div class="details">
                        <h5><a href="<?php echo site_url('/news/'.page_hperlink($row->ID));?>"><?php echo $row->title;?></a></h5>
                        <ul>
                        <li><?php echo date("l, F jS, Y",strtotime($row->post_date));?></li>
                        </ul>
                        <?php echo substr(strip_tags($row->value),0,255);?>...
                        <div class="read_more" align="right"><a href="<?php echo site_url('/news/'.page_hperlink($row->ID));?>">Read More</a></div>
                    </div>
                    <div class="clear"></div>
                    </li> 
                    <?php 
