    ...
    <div id="content">
    	<div class="lsize">
        	...
        	<?php echo get_setting('welcome_text');?>
            </div>
        	<div class="video">
            	<iframe width="320" height="280" src="//www.youtube-nocookie.com/embed/<?php echo $youtuube_id;?>?rel=0" frameborder="0" allowfullscreen></iframe>
            </div>
            <div class="clear"></div>
            </div>
            <div class="pad_t01">
                <!-- Start: Left Patt -->
                <div class="l_part">
                	<h2 class="blue">Latest <b>requests</b></h2>
                    <ul class="short_by">
                    	<li>Sort by</li>
...
$(function() {	
	...
	$('.more').live("click",function(){
		...
		if(ID){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('/home/load_more/');?>",
