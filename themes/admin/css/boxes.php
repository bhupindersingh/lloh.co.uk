...
/* Grid - Headings */
.grid tr.headings               { background:url(<?php echo $iurl;?>/sort_row_bg.gif) 0 50% repeat-x; }
.grid tr.headings th {
    border-width:1px;
...
.grid th a.sort-arrow-desc, .grid th a.sort-arrow-asc {
    background:url(<?php echo $iurl;?>/sort_on_bg.gif) no-repeat;
...
.grid .sort-arrow-desc span.sort-title  { background-image: url(<?php echo $iurl;?>/grid_sort_desc.gif); }
.grid .sort-arrow-asc span.sort-title   { background-image: url(<?php echo $iurl;?>/grid_sort_asc.gif); }
...
.massaction {
    ...
    border-bottom:none;
    background: url(<?php echo $iurl;?>/massaction_bg.gif) repeat-x 0 100% #ebebeb;
    font-size:.9em;
    }
...
/* Grid - Filter */
.grid tr.filter                 { background:url(<?php echo $iurl;?>/filter_row_bg.gif) repeat-x #e3eff1; cursor: default; }
.grid tr.filter th {
    padding-top:5px;
    padding-bottom:5px;
...
dl.accordion dt a, div.collapseable a {
    display:block;
    background: url(<?php echo $iurl;?>/entry_edit_head_arrow_down.gif) 100% 50% no-repeat;
    color:#fff;
    font-weight:bold;
    text-decoration:none;
    }
...
dl.accordion dt.open a, div.collapseable a.open  { background: url(<?php echo $iurl;?>/entry_edit_head_arrow_up.gif) 100% 50% no-repeat; }
...
ul.tabs, ul.tabs a              { background:url(<?php echo $iurl;?>/tabs_link_bg.gif) repeat-y 100% #E7EFEF; }
ul.tabs a:hover                 { background-color:#D8E6E6; background-image:url(<?php echo $iurl;?>/tabs_link_over_bg.gif); }
ul.tabs a.active                { padding:0; border-bottom:1px solid #bebebe; background:none; }
ul.tabs a:hover.active          { padding:0; }
ul.tabs span                    { background:url(<?php echo $iurl;?>/tabs_span_bg.gif) repeat-x 0 100%; padding:.3em 0.5em .28em 1.5em; cursor:pointer; }
...
ul.tabs a.changed span.changed  { background:url(<?php echo $iurl;?>/fam_bullet_disk.gif) 0 0 no-repeat !important; width:16px; height:16px; }
ul.tabs a.error span.error      { background:url(<?php echo $iurl;?>/fam_bullet_error.gif) 0 0 no-repeat !important; width:16px; height:16px; }
ul.tabs a.changed               { font-style:italic; }

/* Horizontal Tabs */
ul.tabs-horiz                   { list-style:none; margin:0 0 18px 0; background:url(<?php echo $iurl;?>/horiz_tabs_ul_bg.gif) repeat-x 0 100% #f8f8f8; padding:8px 0 0 5px; }
...
/* MESSAGES
*******************************************************************************/
.notification-global { padding:5px 27px 5px 47px; background:#fff9e9 url(<?php echo $iurl;?>/error_msg_icon.gif) 27px 5px no-repeat; border-bottom:1px solid #eee2be; font-size:11px; line-height:16px; margin:0 0 -3px; color:#444; position:relative; }
...
.error-msg {
    ...
    background:#faebe7 url(<?php echo $iurl;?>/error_msg_icon.gif) no-repeat 10px 10px !important;
    }
.success-msg {
    border:1px solid #95a486 !important;
    color:#3d6611 !important;
    background:#eff5ea url(<?php echo $iurl;?>/success_msg_icon.gif) no-repeat 10px 10px !important;
    }
.notice-msg {
    border:1px solid #ffd967 !important;
    background:#fffbf0 url(<?php echo $iurl;?>/note_msg_icon.gif) no-repeat 10px 10px !important;
    color:#3d6611 !important;
    }
.warning-msg {
    border:1px solid #666e73 !important;
    background:#e6e6e6 url(<?php echo $iurl;?>/warning_msg_icon.gif) no-repeat 10px 10px !important;
...
.validation-advice {
    ...
    min-height:15px;
    margin:3px 0 0 9px;
    background:url(<?php echo $iurl;?>/validation_advice_bg.gif) no-repeat 2px 1px;
    padding-left:16px;
    font-size:.95em;
    font-weight:bold;
    line-height:1.25em;
...
.entry-edit fieldset li                 { list-style:none; margin:4px 0; }
.entry-edit fieldset input.input-text,
.entry-edit fieldset textarea           { width:270px; }
.entry-edit fieldset textarea           { height:12em; }
.entry-edit fieldset select             { width:276px; }
...
select  {min-height:19px;/* to set the height for empty selects */}
...
.form-list                      { width:auto; border:none !important; }
.main-col .form-list            { width:auto; }
.form-list td                   { border:none !important; padding-top:5px !important; padding-bottom:5px !important; background:none !important;  }
.form-list td.hidden            { border:none !important; padding:0px !important;background:none !important;}
...
.columns .form-list td.value input.input-text { width:260px; }
.columns .form-list td.value textarea    { width:90%; }
.columns .form-list td.value select      { width:267px; }
.columns .form-list td.use-default       { padding-left:15px; }

.columns .form-list td.value .next-toinput {width:75px; display:inline; margin-right:5px;}
.columns .form-list td.value .next-toselect .input-text {width:180px; display:inline;}

.columns .form-list td.value             { width:270px; padding-right:5px; }
.columns .form-list td.value input.input-text,
.columns .form-list td.value textarea    { width:260px; }
.columns .form-list td.value select      { width:267px; }

.form-list td.note              { background:url(<?php echo $iurl;?>/note_cell_bg.gif) no-repeat 6px 10px !important; padding-left:18px;}
...
.sub-btn-set {
    ...
    border-color:#ddd;
    border-style:solid;
    background:url(<?php echo $iurl;?>/sub_button_bg.gif) repeat;
    padding:3px 10px;
    text-align:right;
    }
button, .form-button {
    ...
    background:url(<?php echo $iurl;?>/btn_bg.gif) #ffac47 repeat-x 0 100%;
    color:#fff;
...
button:hover                    { background: url(<?php echo $iurl;?>/btn_over_bg.gif) repeat-x 0 0 #f77c16; }
button:active                   { background: url(<?php echo $iurl;?>/btn_on_bg.gif) repeat-x 0 0 #f77c16; }
...
button.back {
    ...
    background-image:url(<?php echo $iurl;?>/btn_back_bg.gif);
    color:#555;
    }
button.back span                { background-image:url(<?php echo $iurl;?>/icon_btn_back.gif); }
button.cancel:active            { background-image:url(<?php echo $iurl;?>/cancel_btn_active_bg.gif); }
button.cancel, button.delete    {
    border-color:#d24403 #a92000 #a92000 #d24403;
    background-image:url(<?php echo $iurl;?>/cancel_btn_bg.gif);
    background-color:#fcaf81;
    color:#fff;
    }
button.cancel:hover, button.delete:hover { background-image: url(<?php echo $iurl;?>/cancel_btn_over_bg.gif); }
button.cancel:active,
button.delete:active            { background-image:url(<?php echo $iurl;?>/cancel_btn_active_bg.gif); background-color:#e0612f; }
button.cancel span, button.delete span {
    background-image:url(<?php echo $iurl;?>/cancel_btn_icon.gif);
    }
button.add span     { background-image:url(<?php echo $iurl;?>/add_btn_icon.gif); }
button.save span    { background-image:url(<?php echo $iurl;?>/save_btn_icon.gif); }
...
.side-col .switcher select { width:95%; }
...
.scroll-cont {
    ...
    width:16px;
    height:265px;
    background:transparent url(<?php echo $iurl;?>/db-scroll-bg.gif) no-repeat top;
    z-index:10000;
    }
...
.note-list li { border-top:1px solid #e3e3e3; margin-top:9px !important; background:url(<?php echo $iurl;?>/icon_note_list.gif) no-repeat 0 3px; padding-bottom:9px; padding-left:18px; }
...
.header { background:url(<?php echo $iurl;?>/header_top_bg.gif) repeat-x #425e66; text-align:right; }
.middle {
    min-height:450px;
    background:url(<?php echo $iurl;?>/simple_container_bg.gif) repeat-x #fff;
    padding:23px 27px 0 27px;
    }
.middle-popup {
    border-bottom:3px solid #fff;
    background:url(<?php echo $iurl;?>/middle_bg.gif) repeat-x 0 100% #fff;
    padding:0 0 0 0;
    background:yellow;
    }
.container-collapsed {
...
.columns {background:url(<?php echo $iurl;?>/side_col_bg.gif) repeat-y 217px 0;}
div.side-col {
    float:left;
    width:220px;
    padding-bottom:25px;
...
.footer {
    clear:both;
    background:url(<?php echo $iurl;?>/footer_bg.gif) repeat-x #e6e6e6;
...
.simple-container-popup {
    ...
    background:url(<?php echo $iurl;?>/simple_container_bg.gif) repeat-x;
    }
...
.logo                                   { float:left; margin:5px 20px 5px 27px; height:75px; }
...
.head-customer-address-list     { background-image:url(<?php echo $iurl;?>/fam_house.gif); }
.head-edit-form                 { background-image:url(<?php echo $iurl;?>/fam_page_white.gif); }
.head-customer-view             { background-image:url(<?php echo $iurl;?>/fam_status_online.gif); padding-left:18px; }
.head-customer,
.head-customer-groups           { background-image:url(<?php echo $iurl;?>/fam_group.gif); }
.head-user                      { background-image:url(<?php echo $iurl;?>/fam_user.gif); }
.head-user-edit                 { background-image:url(<?php echo $iurl;?>/fam_user_edit.gif); }
.head-user-comment              { background-image:url(<?php echo $iurl;?>/fam_user_comment.gif); }
.head-comment                   { background-image:url(<?php echo $iurl;?>/fam_comment.gif); }
.head-cart                      { background-image:url(<?php echo $iurl;?>/fam_cart.gif); }
.head-account                   { background-image:url(<?php echo $iurl;?>/fam_account.gif); }
.head-online-visitors           { background-image:url(<?php echo $iurl;?>/fam_monitor.gif); }
.head-products                  { background-image:url(<?php echo $iurl;?>/fam_package.gif); }
.head-catalog-product           { background-image:url(<?php echo $iurl;?>/fam_package.gif); }
.head-newsletter-queue          { background-image:url(<?php echo $iurl;?>/fam_newspaper_go.gif); }
.head-newsletter-list           { background-image:url(<?php echo $iurl;?>/fam_newspaper.gif); }
.head-newsletter-report         { background-image:url(<?php echo $iurl;?>/fam_newspaper_error.gif); }
.head-tag, .head-tag-product    { background-image:url(<?php echo $iurl;?>/fam_tag_orange.gif); }
.head-sales-order,
.head-sales-invoice             { background-image:url(<?php echo $iurl;?>/fam_folder_table.gif); }
.head-categories                { background-image:url(<?php echo $iurl;?>/fam_folder_database.gif); padding-left:20px; color:#253033 !important; }
.head-catalog-product-attribute { background-image:url(<?php echo $iurl;?>/fam_rainbow.gif); padding-left:24px; }
.head-product-attribute-sets    { background-image:url(<?php echo $iurl;?>/fam_folder_palette.gif); padding-left:23px; }
.head-tax                       { background-image:url(<?php echo $iurl;?>/fam_money_add.gif); }
.head-cms-page, .head-cms-block { background-image:url(<?php echo $iurl;?>/application_view_tile.gif); }
.head-backups-control           { background-image:url(<?php echo $iurl;?>/fam_server_database.gif); }
.head-money, .head-promo-quote  { background-image:url(<?php echo $iurl;?>/fam_money.gif); }
.head-shipping-address,
.head-billing-address           { background-image:url(<?php echo $iurl;?>/fam_house.gif); }
.head-shipping-method           { background-image:url(<?php echo $iurl;?>/fam_lorry.gif); }
.head-payment-method            { background-image:url(<?php echo $iurl;?>/fam_creditcards.gif); }
.head-order-date                { background-image:url(<?php echo $iurl;?>/fam_calendar.gif); }
.head-customer-sales-statistics { background-image:url(<?php echo $iurl;?>/fam_money.gif); }
.head-notification              { background-image:url(<?php echo $iurl;?>/fam_folder_table.gif); }
...
.login-container                        { width:581px; padding-left:32px; margin:170px auto; text-align:center; }
.login-box                              { position:relative; }
.login-form                             { padding:27px 57px 35px 57px; background:url(<?php echo $iurl;?>/login_box_bg.jpg) no-repeat; text-align:left; }
.login-form #messages                   { margin:0 8px 0 0; }
...
.login-box .bottom  {
    width:581px;
    height:5px;
    background:url(<?php echo $iurl;?>/login_box_bottom.jpg) no-repeat;
    overflow:hidden;
    }
.login-container .legal {
    margin:0;
    background:url(<?php echo $iurl;?>/login_box_legal_bg.gif) no-repeat;
...
ul.item-options { list-style:none; }
...
.order-choose-address                   { margin:0px 0px 10px 0px;padding:8px 15px;background:#e7efef; } /*Address Selector */
.order-save-in-address-book             { margin:0px 0px 0px 0px;padding:8px 15px;background:#e7efef; } /*Save in Address Book Checkbox */
...
.entry-edit .order-address .textarea    { width:95%; }
.entry-edit .order-address .select      { width:97.5%; }
.order-search-items .entry-edit .grid   { height:610px;overflow: auto;}
.order-search-items .entry-edit .grid table {width:99.9%; }
/* .create-order-totals                 { background:url(<?php echo $iurl;?>/bg_create_order_totals.gif) repeat-y 50% 0 !important; } */

/* Account Information */
.account-info .form-list td.value       { width:auto; }
...
.order-totals table td                  { padding:3px 20px 3px 10px; white-space:nowrap; }
...
.tax-total .tax-collapse { float:right; padding-left:20px; background:url(<?php echo $iurl;?>/bg_collapse.gif) 0 5px no-repeat; text-align:right; cursor:pointer; }
...
.payment-methods dd                     { outline-color: none !important;margin-left: 20px; }
.payment-methods .validation-advice     { margin-left:2px; }

/* Gift Messages */ /*#################### NEEDS CLEAN UP #########################*/
.giftmessage-order-create .entire-order,
.giftmessage-order-create .each-order-item          { padding:1.2em 1.5em; padding-right:0; padding-left:1.2em; }
.giftmessage-order-create .each-order-item          { height: 275px;}
.giftmessage-order-create .each-order-item .scroll  { overflow: auto; height: 250px; }
.giftmessage-order-create .single                   { width:100%; float:left; padding:1.2em 1.5em; }
.giftmessage-order-create .section-head             { margin-bottom: 10px; }
.giftmessage-order-create .item-head                { background-color:#cfcfcf; margin-bottom:10px; width:400px; padding:2px 6px; font-size:11px; }
.giftmessage-order-create .entire-order             { background-color:#eee; height: 275px; }
.giftmessage-order-create fieldset                  { padding: 0 0 0 0; }
.giftmessage-order-create .entry-edit .input-text,
.giftmessage-order-create .entry-edit .textarea     { width:220px; }
...
.giftmessage-single-item .gift-form                 { margin-top:3px; background:#f7f6f4 url(<?php echo $iurl;?>/gift-message-grid-column-bg.gif) 0 0 repeat-x; zoom:1; }
...
.giftmessage-single-item .action-link { padding-right:10px; background:url(<?php echo $iurl;?>/gift-message-expand.gif) 100% 50% no-repeat; cursor:pointer; }
.giftmessage-single-item .open { background:url(<?php echo $iurl;?>/gift-message-collapse.gif) 100% 50% no-repeat; }
...
.x-tree-node .leaf .x-tree-node-icon        { background-image:url(<?php echo $iurl;?>/fam_leaf.png); }
.x-tree-node .system-leaf .x-tree-node-icon { background-image:url(<?php echo $iurl;?>/fam_application_form_delete.png); }

#category_info_tabs_general_content .checkbox { float:left; margin:3px 3px 0 25px; }
...
.rating-box {
    ...
    height:16px;
    margin:0 5px 3px 0;
    background:url(<?php echo $iurl;?>/product_rating_blank_star.gif) repeat-x;
    }
.rating-box .rating {
    position:absolute;
    top:0;
    left:0;
    height:16px;
    background:url(<?php echo $iurl;?>/product_rating_full_star.gif) repeat-x;
    }
...
.rule-param input,
.rule-param select              { width:auto !important; }
...
.rule-param-wait                { padding-left:20px; background-image:url(<?php echo $iurl;?>/rule-ajax-loader.gif); background-repeat:no-repeat; background-position:0 50%; }

fieldset.sitemap .form-list { width:auto; }
...
.custom-options .option-box  .border .input-text,
.custom-options .option-box  .border .select{width:95%!important;}

.custom-options .option-box  .border .type-last  .input-text {width:60px!important;}
...
.address-list li                        { position:relative; list-style:none; padding:12px 14px; cursor:pointer; border-top:1px solid #e6e6e6; background:url(<?php echo $iurl;?>/address_list_li.gif) repeat; }
...
/* NEWSLETTER
*******************************************************************************/
.template-preview           { width: 100%; height: 200px; background-color: #FFFFFF; }

/* CUSTOMER
*******************************************************************************/
.cms-edit-form .form-list { width:100%; }
.cms-edit-form .form-list td.value { width:auto; }
...
div.tree_item               { background-image:url(<?php echo $iurl;?>/tree_icons/join.gif); }
div.tree_item_last          { background-image:url(<?php echo $iurl;?>/tree_icons/joinbottom.gif); }
div.tree_line               { position:absolute; left:0; background-image:url(<?php echo $iurl;?>/tree_icons/line.gif); }
...
ul.config-tabs dt {
    ...
    background:#d1dedf url(<?php echo $iurl;?>/config_tab_dt_bg.gif) no-repeat 0 50%;
...
.attribute-change-checkbox label{ margin-left: 5px; float: none !important; display: normal;}
...
.grid tr.read { background:#ffffff !important; }
...
.grid-severity-major,
.grid-severity-minor,
.grid-severity-notice   { display:block; color:#fff; font-family:Arial, Tahoma, Verdana; font-weight:bold; font-size:10px; text-transform:uppercase; text-align:center; height:13px; padding-top:3px; width:61px; margin:1px 0; line-height:1; }
.grid-severity-critical { background:url(<?php echo $iurl;?>/bg_severity-critical.gif) no-repeat 0 0; }
.grid-severity-major    { background:url(<?php echo $iurl;?>/bg_severity-major.gif) no-repeat 0 0; }
.grid-severity-minor    { background:url(<?php echo $iurl;?>/bg_severity-minor.gif) no-repeat 0 0; }
.grid-severity-notice   { background:url(<?php echo $iurl;?>/bg_severity-notice.gif) no-repeat 0 0; }


.super-attributes                       { list-style-type:none; margin:0; padding:0; }
.super-attributes li.attribute          { border: 1px solid #dfdfdf; background-color: #ededed; margin: 1px 0; }
.super-attributes li.attribute ul.attribute-values { list-style-type:none; margin:0; padding:0; }
...
.super-attributes li.attribute-value .validation-advice { margin:0; white-space: wrap; }
...
.super-attributes  div.attribute-name-container {
    cursor:move;
    background-image: url(<?php echo $iurl;?>/arrow_sort_move.gif);
    background-repeat: no-repeat;
...
.preview .cell-position .input-text     { width: 90% !important; }

.tier .data             { width:480px; }
.tier .data select      { width:99%; }
.tier .data input.qty   { width: 20px !important; }
.tier .data .last { width:33px; }


/* Links */
.link-feed { background:url(<?php echo $iurl;?>/icon_feed.gif) no-repeat left 2px; padding-left:18px; }

#page-help-link {
    line-height:26px;
    padding-left:20px;
    color:#ebebff;
    background: url(<?php echo $iurl;?>/fam_help.gif) no-repeat 0 50%;
    }
